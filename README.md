...
> **Note (2026-01-26)**: This repository has been extended for a research project on **Human-AI Collaborative Labeling Efficiency & Quality**. 
> - **v2.0 Update**: Added Robust Append, Selection Bias correction (IoU 0.0), and Manifest-driven analysis.
> - Please refer to the [HOHONET 2026 Experiment Overview](docs/SOP_labelstudio_experiment.md) for current workflows.
>
> 🚀 **New Key Tools**:
> - [tools/analyze_quality.py](tools/analyze_quality.py): Unified quality/efficiency analysis script (v2.0).
> - [tools/visualize_output.ipynb](tools/visualize_output.ipynb): Table/Figure generator (v2.0).
> - [docs/README_INDEX.md](docs/README_INDEX.md): Full documentation index.
