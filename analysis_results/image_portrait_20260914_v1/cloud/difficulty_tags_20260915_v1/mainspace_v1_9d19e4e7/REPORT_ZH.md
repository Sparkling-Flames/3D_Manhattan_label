...
楼级配对重采样给出相同覆盖的区间；同房分析另报组件宏平均。同楼的视角、人群重排、模型旋转和六面不增加独立样本。全体比较包含189,528条逐图折外预测，来自1,788个方法配置，**不是这些数量的独立研究样本**。
...
| 方法                        | 拟合                 |    RPS |   准确率 |   平衡准确率 |
|:----------------------------|:---------------------|-------:|---------:|-------------:|
| 总体标签频数                | 整体                 | 0.2058 |   0.4623 |       0.3333 |
| 人工大类频数                | 整体                 | 0.1110 |   0.7736 |       0.8049 |
| 主空间功能频数              | 整体                 | 0.1000 |   0.8113 |       0.8374 |
| 已有四模型/反馈：训练侧选层 | 整体＋主空间基线     | 0.0884 |   0.8113 |       0.8374 |
| 低维模型反馈：训练侧选择    | 整体＋主空间基线     | 0.0806 |   0.8113 |       0.8374 |
| DINO：训练侧选层            | 整体＋主空间基线     | 0.1211 |   0.6981 |       0.7150 |
| 已有信息＋DINO：训练侧混合  | 整体＋主空间基线     | 0.0965 |   0.7830 |       0.8170 |
| 已有四模型/反馈：训练侧选层 | 大类内分别拟合       | 0.0771 |   0.7925 |       0.7844 |
| 低维模型反馈：训练侧选择    | 大类内分别拟合       | 0.0799 |   0.7830 |       0.7622 |
| DINO：训练侧选层            | 大类内分别拟合       | 0.1123 |   0.6698 |       0.7020 |
| 已有信息＋DINO：训练侧混合  | 大类内分别拟合       | 0.0777 |   0.7925 |       0.7971 |
| 已有四模型/反馈：训练侧选层 | 主空间功能内分别拟合 | 0.0682 |   0.8396 |       0.8237 |
| 低维模型反馈：训练侧选择    | 主空间功能内分别拟合 | 0.0739 |   0.8208 |       0.7947 |
| DINO：训练侧选层            | 主空间功能内分别拟合 | 0.1043 |   0.7075 |       0.7345 |
| 已有信息＋DINO：训练侧混合  | 主空间功能内分别拟合 | 0.0695 |   0.8396 |       0.8364 |
...
| comparison                                              |   n_images |   rps_delta |   rps_delta_lo |   rps_delta_hi |   accuracy_delta |
|:--------------------------------------------------------|-----------:|------------:|---------------:|---------------:|-----------------:|
| within_main existing[main,ridge] vs baseline__main      |        106 |     -0.0318 |        -0.0692 |        -0.0139 |           0.0283 |
| within_main dinov3 vs existing [main,ridge]             |        106 |      0.0361 |         0.0119 |         0.0800 |          -0.1321 |
| within_main existing_plus_dino vs existing [main,ridge] |        106 |      0.0013 |         0.0000 |         0.0047 |           0.0000 |
| within_main existing vs feedback [main,ridge]           |        106 |     -0.0057 |        -0.0167 |         0.0017 |           0.0189 |
...
| feature                             |   n_images |   n_components |   rps_mean |   accuracy |   hard_recall |
|:------------------------------------|-----------:|---------------:|-----------:|-----------:|--------------:|
| dinov3__block12__panorama_mean__nn1 |         54 |              9 |     0.0185 |     0.9630 |        0.5000 |
| dinov3__block3__panorama_mean__nn1  |         54 |              9 |     0.0463 |     0.9074 |        0.5000 |
| dinov3__cls__panorama__nn1          |         54 |              9 |     0.0185 |     0.9630 |        0.5000 |
| feedback__point_counts__fixed_ridge |         54 |              9 |     0.0327 |     0.8889 |        1.0000 |
| same_room_frequency                 |         54 |              9 |     0.0510 |     0.8519 |        0.0000 |
...
| condition   | confirmation    |      2 |       3 |       4 |       5 |       6 |       7 |
|:------------|:----------------|-------:|--------:|--------:|--------:|--------:|--------:|
| manual      | suffix_and_tail | 6.0000 | 10.0000 | 10.0000 | 10.0000 | 10.0000 | 10.0000 |
| manual      | suffix_only     | 6.0000 | 11.0000 | 14.0000 | 15.0000 | 15.0000 | 15.0000 |
| semi        | suffix_and_tail | 2.0000 |  2.0000 |  2.0000 |  2.0000 |  2.0000 |  2.0000 |
| semi        | suffix_only     | 2.0000 |  3.0000 |  3.0000 |  3.0000 |  3.0000 |  3.0000 |
