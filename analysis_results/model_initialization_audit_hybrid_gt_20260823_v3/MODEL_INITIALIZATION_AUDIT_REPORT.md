# HoHoNet 模型布局初始化代理全量审计（Test 混合 GT v3）
...
- 全量逐图 CSV：`analysis_results/model_initialization_audit_hybrid_gt_20260823_v3/model_initialization_metrics.csv`
- 运行清单：`analysis_results/model_initialization_audit_hybrid_gt_20260823_v3/run_manifest.json`
