...
- Input SHA-256: `b261d4dfe5a495672ef794c858dddb9716a2ae3987c204b292d2e29c51bfc5ef`
...
### m_anchor_4_1_1_a_0083 | m_anchor_4_1_1_staged_micro_compensation_probe | neutral_geometry_tradeoff
...
### m_anchor_4_1_1_a_0084 | m_anchor_4_1_1_staged_micro_compensation_probe | neutral_geometry_tradeoff
...
- Applied coordinate changes:
  ...
  - source pair 9 (solver position 9): no numeric change
  - source pair 10 (solver position 10): no numeric change
- wall residual sum: 36.741 -> 36.270
- Preview only; this is not correctness evidence and cannot write back.

### m_anchor_4_1_1_b_0434 | m_anchor_4_1_1_staged_micro_compensation_probe | neutral_geometry_tradeoff
...
### m_anchor_4_1_1_c_1184 | m_anchor_4_1_1_staged_micro_compensation_probe | neutral_geometry_tradeoff
...
| m_anchor_4_1_1_a_0083 | 36.097 | 12.415 | 2.006 | 0.000 | 0.202 | False |
| m_anchor_4_1_1_a_0084 | 36.270 | 12.562 | 2.001 | 0.000 | 0.202 | False |
| m_anchor_4_1_1_b_0434 | 34.600 | 14.069 | 2.029 | 0.000 | 0.202 | False |
| m_anchor_4_1_1_c_1184 | 29.282 | 16.062 | 2.051 | 0.000 | 0.202 | False |
...
## Pair 3D Coordinates — m_anchor_4_1_1_a_0083
...
## Wall Metrics — m_anchor_4_1_1_a_0083
...
## Corner Metrics — m_anchor_4_1_1_a_0083
...
## Pair 3D Coordinates — m_anchor_4_1_1_a_0084
...
| 6 | 5 | (-0.228, -1.600, -0.618) | (-0.228, 1.759, -0.618) | 3.359 | 0.000 | none |
| 7 | 8 | (0.083, -1.600, -0.636) | (0.083, 1.759, -0.636) | 3.359 | -0.000 | none |
| 8 | 7 | (0.034, -1.600, -1.449) | (0.034, 1.764, -1.449) | 3.364 | 0.006 | none |
| 9 | 9 | (1.820, -1.600, -1.558) | (1.820, 1.561, -1.558) | 3.161 | -0.197 | none |
| 10 | 10 | (1.977, -1.600, 1.169) | (1.977, 1.620, 1.169) | 3.220 | -0.138 | none |
| 11 | 12 | (0.087, -1.600, 1.265) | (0.087, 1.683, 1.265) | 3.283 | -0.076 | none |
| 12 | None | (0.043, -1.600, 0.418) | (0.043, 1.015, 0.418) | 2.615 | -0.743 | none |

## Wall Metrics — m_anchor_4_1_1_a_0084
...
| 5 | 5-6 | 0.403 | 86.544 | 90.000 | 3.456 | False |
| 6 | 6-7 | 0.312 | 356.544 | 0.000 | 3.456 | True |
| 7 | 7-8 | 0.814 | 266.571 | 270.000 | 3.429 | False |
| 8 | 8-9 | 1.789 | 356.497 | 0.000 | 3.503 | False |
| 9 | 9-10 | 2.732 | 86.702 | 90.000 | 3.298 | False |
| 10 | 10-11 | 1.892 | 177.089 | 180.000 | 2.911 | False |
| 11 | 11-12 | 0.849 | 266.991 | 270.000 | 3.009 | False |
| 12 | 12-1 | 0.202 | 182.466 | 180.000 | 2.466 | True |

## Corner Metrics — m_anchor_4_1_1_a_0084
...
| 5 | 4 | 5 | 89.813 | 0.187 | False |
| 6 | 5 | 6 | 90.000 | 0.000 | False |
| 7 | 6 | 7 | 90.027 | 0.027 | False |
| 8 | 7 | 8 | 90.074 | 0.074 | False |
| 9 | 8 | 9 | 89.796 | 0.204 | False |
| 10 | 9 | 10 | 89.613 | 0.387 | False |
| 11 | 10 | 11 | 90.098 | 0.098 | False |
| 12 | 11 | 12 | 95.475 | 5.475 | False |

## Pair 3D Coordinates — m_anchor_4_1_1_b_0434
...
## Wall Metrics — m_anchor_4_1_1_b_0434
...
## Corner Metrics — m_anchor_4_1_1_b_0434
...
## Pair 3D Coordinates — m_anchor_4_1_1_c_1184
...
## Wall Metrics — m_anchor_4_1_1_c_1184
...
## Corner Metrics — m_anchor_4_1_1_c_1184
