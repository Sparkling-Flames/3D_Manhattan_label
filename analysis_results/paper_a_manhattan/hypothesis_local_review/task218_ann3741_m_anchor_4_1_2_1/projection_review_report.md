...
### m_anchor_4_1_2_a_0082 | m_anchor_4_1_2_visible_range | neutral_geometry_tradeoff
...
- Applied coordinate changes:
  ...
  - source pair 7 (solver position 8): bottom_y 76.621→76.471 (Δ -0.150)
  - source pair 9 (solver position 9): top_x 63.781→63.731 (Δ -0.050), bottom_x 63.781→63.731 (Δ -0.050)
  - source pair 10 (solver position 10): top_x 83.350→83.500 (Δ 0.150), bottom_x 83.350→83.500 (Δ 0.150)
- wall residual sum: 36.741 -> 35.924
- Preview only; this is not correctness evidence and cannot write back.

### m_anchor_4_1_2_a_0083 | m_anchor_4_1_2_visible_range | neutral_geometry_tradeoff
...
- Applied coordinate changes:
  - source pair 4 (solver position 4): top_x 27.411→27.361 (Δ -0.050), bottom_x 27.411→27.361 (Δ -0.050)
  - source pair 7 (solver position 8): bottom_y 76.621→76.521 (Δ -0.100)
  - source pair 9 (solver position 9): top_x 63.781→63.731 (Δ -0.050), bottom_x 63.781→63.731 (Δ -0.050)
  - source pair 10 (solver position 10): top_x 83.350→83.500 (Δ 0.150), bottom_x 83.350→83.500 (Δ 0.150)
- wall residual sum: 36.741 -> 36.097
- Preview only; this is not correctness evidence and cannot write back.

### m_anchor_4_1_2_b_0598 | m_anchor_4_1_2_visible_range | neutral_geometry_tradeoff
...
- Applied coordinate changes:
  - source pair 4 (solver position 4): top_x 27.411→27.361 (Δ -0.050), bottom_x 27.411→27.361 (Δ -0.050)
  - source pair 7 (solver position 8): bottom_y 76.621→76.321 (Δ -0.300)
  - source pair 9 (solver position 9): top_x 63.781→63.731 (Δ -0.050), bottom_x 63.781→63.731 (Δ -0.050)
  - source pair 10 (solver position 10): top_x 83.350→83.650 (Δ 0.300), bottom_x 83.350→83.650 (Δ 0.300)
- wall residual sum: 36.741 -> 34.600
- Preview only; this is not correctness evidence and cannot write back.

### m_anchor_4_1_2_c_1976 | m_anchor_4_1_2_visible_range | neutral_geometry_tradeoff
...
- Applied coordinate changes:
  - source pair 3 (solver position 3): top_x 9.128→9.628 (Δ 0.500), bottom_x 9.128→9.628 (Δ 0.500)
  - source pair 4 (solver position 4): top_x 27.411→27.361 (Δ -0.050), bottom_x 27.411→27.361 (Δ -0.050)
  - source pair 7 (solver position 8): bottom_y 76.621→75.621 (Δ -1.000)
  - source pair 9 (solver position 9): top_x 63.781→63.731 (Δ -0.050), bottom_x 63.781→63.731 (Δ -0.050)
  - source pair 10 (solver position 10): top_x 83.350→84.350 (Δ 1.000), bottom_x 83.350→84.350 (Δ 1.000)
...
| m_anchor_4_1_2_a_0082 | 35.924 | 12.593 | 2.012 | 0.000 | 0.202 | False |
| m_anchor_4_1_2_a_0083 | 36.097 | 12.415 | 2.006 | 0.000 | 0.202 | False |
| m_anchor_4_1_2_b_0598 | 34.600 | 14.069 | 2.029 | 0.000 | 0.202 | False |
...
## Pair 3D Coordinates — m_anchor_4_1_2_a_0082
...
## Wall Metrics — m_anchor_4_1_2_a_0082
...
## Corner Metrics — m_anchor_4_1_2_a_0082
...
## Pair 3D Coordinates — m_anchor_4_1_2_a_0083
...
| 6 | 5 | (-0.228, -1.600, -0.618) | (-0.228, 1.759, -0.618) | 3.359 | 0.000 | none |
| 7 | 8 | (0.083, -1.600, -0.636) | (0.083, 1.759, -0.636) | 3.359 | -0.000 | none |
| 8 | 7 | (0.035, -1.600, -1.454) | (0.035, 1.770, -1.454) | 3.370 | 0.011 | none |
| 9 | 9 | (1.820, -1.600, -1.558) | (1.820, 1.561, -1.558) | 3.161 | -0.197 | none |
| 10 | 10 | (1.977, -1.600, 1.169) | (1.977, 1.620, 1.169) | 3.220 | -0.138 | none |
| 11 | 12 | (0.087, -1.600, 1.265) | (0.087, 1.683, 1.265) | 3.283 | -0.076 | none |
| 12 | None | (0.043, -1.600, 0.418) | (0.043, 1.015, 0.418) | 2.615 | -0.743 | none |

## Wall Metrics — m_anchor_4_1_2_a_0083
...
| 5 | 5-6 | 0.403 | 86.544 | 90.000 | 3.456 | False |
| 6 | 6-7 | 0.312 | 356.544 | 0.000 | 3.456 | True |
| 7 | 7-8 | 0.819 | 266.598 | 270.000 | 3.402 | False |
| 8 | 8-9 | 1.789 | 356.644 | 0.000 | 3.356 | False |
| 9 | 9-10 | 2.732 | 86.702 | 90.000 | 3.298 | False |
| 10 | 10-11 | 1.892 | 177.089 | 180.000 | 2.911 | False |
| 11 | 11-12 | 0.849 | 266.991 | 270.000 | 3.009 | False |
| 12 | 12-1 | 0.202 | 182.466 | 180.000 | 2.466 | True |

## Corner Metrics — m_anchor_4_1_2_a_0083
...
| 5 | 4 | 5 | 89.813 | 0.187 | False |
| 6 | 5 | 6 | 90.000 | 0.000 | False |
| 7 | 6 | 7 | 90.054 | 0.054 | False |
| 8 | 7 | 8 | 89.954 | 0.046 | False |
| 9 | 8 | 9 | 89.942 | 0.058 | False |
| 10 | 9 | 10 | 89.613 | 0.387 | False |
| 11 | 10 | 11 | 90.098 | 0.098 | False |
| 12 | 11 | 12 | 95.475 | 5.475 | False |

## Pair 3D Coordinates — m_anchor_4_1_2_b_0598
...
| 6 | 5 | (-0.228, -1.600, -0.618) | (-0.228, 1.759, -0.618) | 3.359 | 0.000 | none |
| 7 | 8 | (0.083, -1.600, -0.636) | (0.083, 1.759, -0.636) | 3.359 | -0.000 | none |
| 8 | 7 | (0.035, -1.600, -1.472) | (0.035, 1.792, -1.472) | 3.392 | 0.034 | none |
| 9 | 9 | (1.820, -1.600, -1.558) | (1.820, 1.561, -1.558) | 3.161 | -0.197 | none |
| 10 | 10 | (1.966, -1.600, 1.188) | (1.966, 1.620, 1.188) | 3.220 | -0.138 | none |
| 11 | 12 | (0.087, -1.600, 1.265) | (0.087, 1.683, 1.265) | 3.283 | -0.076 | none |
| 12 | None | (0.043, -1.600, 0.418) | (0.043, 1.015, 0.418) | 2.615 | -0.743 | none |

## Wall Metrics — m_anchor_4_1_2_b_0598
...
| 5 | 5-6 | 0.403 | 86.544 | 90.000 | 3.456 | False |
| 6 | 6-7 | 0.312 | 356.544 | 0.000 | 3.456 | True |
| 7 | 7-8 | 0.837 | 266.703 | 270.000 | 3.297 | False |
| 8 | 8-9 | 1.787 | 357.234 | 0.000 | 2.766 | False |
| 9 | 9-10 | 2.750 | 86.955 | 90.000 | 3.045 | False |
| 10 | 10-11 | 1.880 | 177.637 | 180.000 | 2.363 | False |
| 11 | 11-12 | 0.849 | 266.991 | 270.000 | 3.009 | False |
| 12 | 12-1 | 0.202 | 182.466 | 180.000 | 2.466 | True |

## Corner Metrics — m_anchor_4_1_2_b_0598
...
| 5 | 4 | 5 | 89.813 | 0.187 | False |
| 6 | 5 | 6 | 90.000 | 0.000 | False |
| 7 | 6 | 7 | 90.159 | 0.159 | False |
| 8 | 7 | 8 | 89.469 | 0.531 | False |
| 9 | 8 | 9 | 90.279 | 0.279 | False |
| 10 | 9 | 10 | 89.318 | 0.682 | False |
| 11 | 10 | 11 | 90.647 | 0.647 | False |
| 12 | 11 | 12 | 95.475 | 5.475 | False |

## Pair 3D Coordinates — m_anchor_4_1_2_c_1976
...
## Wall Metrics — m_anchor_4_1_2_c_1976
...
## Corner Metrics — m_anchor_4_1_2_c_1976
...
## Pair 3D Coordinates — m_anchor_4_1_2_d_3426
...
| 6 | 5 | (-0.228, -1.600, -0.618) | (-0.228, 1.759, -0.618) | 3.359 | 0.000 | none |
| 7 | 8 | (0.083, -1.600, -0.636) | (0.083, 1.759, -0.636) | 3.359 | -0.000 | none |
| 8 | 7 | (0.037, -1.600, -1.538) | (0.037, 1.873, -1.538) | 3.473 | 0.114 | none |
| 9 | 9 | (1.820, -1.600, -1.558) | (1.820, 1.561, -1.558) | 3.161 | -0.197 | none |
| 10 | 10 | (1.912, -1.600, 1.273) | (1.912, 1.620, 1.273) | 3.220 | -0.138 | none |
| 11 | 12 | (0.087, -1.600, 1.265) | (0.087, 1.683, 1.265) | 3.283 | -0.076 | none |
| 12 | None | (0.043, -1.600, 0.418) | (0.043, 1.015, 0.418) | 2.615 | -0.743 | none |

## Wall Metrics — m_anchor_4_1_2_d_3426
...
| 5 | 5-6 | 0.403 | 86.544 | 90.000 | 3.456 | False |
| 6 | 6-7 | 0.312 | 356.544 | 0.000 | 3.456 | True |
| 7 | 7-8 | 0.903 | 267.045 | 270.000 | 2.955 | False |
| 8 | 8-9 | 1.784 | 359.360 | 0.000 | 0.640 | False |
| 9 | 9-10 | 2.833 | 88.140 | 90.000 | 1.860 | False |
| 10 | 10-11 | 1.825 | 180.244 | 180.000 | 0.244 | False |
| 11 | 11-12 | 0.849 | 266.991 | 270.000 | 3.009 | False |
| 12 | 12-1 | 0.202 | 182.466 | 180.000 | 2.466 | True |

## Corner Metrics — m_anchor_4_1_2_d_3426
...
| 5 | 4 | 5 | 89.813 | 0.187 | False |
| 6 | 5 | 6 | 90.000 | 0.000 | False |
| 7 | 6 | 7 | 90.501 | 0.501 | False |
| 8 | 7 | 8 | 87.685 | 2.315 | False |
| 9 | 8 | 9 | 91.220 | 1.220 | False |
| 10 | 9 | 10 | 87.895 | 2.105 | False |
| 11 | 10 | 11 | 93.254 | 3.254 | False |
| 12 | 11 | 12 | 95.475 | 5.475 | False |

## Pair 3D Coordinates — m_anchor_4_1_2_d_2886
...
## Wall Metrics — m_anchor_4_1_2_d_2886
...
## Corner Metrics — m_anchor_4_1_2_d_2886
...
## Pair 3D Coordinates — m_anchor_4_1_2_1_visibility_s4_0_15
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s4_0_15
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s4_0_15
...
| 2 | 1 | (-0.141, -1.600, 6.556) | (-0.141, 1.759, 6.556) | 3.359 | 0.000 | none |
| 3 | 3 | (-4.401, -1.600, 6.813) | (-4.401, 1.759, 6.813) | 3.359 | 0.000 | none |
| 4 | 4 | (-4.870, -1.600, -0.650) | (-4.870, 1.759, -0.650) | 3.359 | 0.000 | none |
| 5 | 6 | (-0.252, -1.600, -1.020) | (-0.252, 1.759, -1.020) | 3.359 | 0.000 | none |
| 6 | 5 | (-0.228, -1.600, -0.618) | (-0.228, 1.759, -0.618) | 3.359 | 0.000 | none |
| 7 | 8 | (0.083, -1.600, -0.636) | (0.083, 1.759, -0.636) | 3.359 | -0.000 | none |
| 8 | 7 | (0.034, -1.600, -1.444) | (0.034, 1.759, -1.444) | 3.359 | 0.000 | none |
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s4_0_30

| wall | from-to | length | direction | nearest axis | residual | short |
| ---: | --- | ---: | ---: | ---: | ---: | --- |
| 1 | 1-2 | 6.147 | 89.837 | 90.000 | 0.163 | False |
| 2 | 2-3 | 4.268 | 176.544 | 180.000 | 3.456 | False |
| 3 | 3-4 | 7.478 | 266.401 | 270.000 | 3.599 | False |
| 4 | 4-5 | 4.633 | 355.422 | 0.000 | 4.578 | False |
| 5 | 5-6 | 0.403 | 86.544 | 90.000 | 3.456 | False |
| 6 | 6-7 | 0.312 | 356.544 | 0.000 | 3.456 | True |
| 7 | 7-8 | 0.809 | 266.544 | 270.000 | 3.456 | False |
| 8 | 8-9 | 1.789 | 356.352 | 0.000 | 3.648 | False |
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s4_0_30

| pair | prev wall | next wall | turn angle | residual to 90 | warning |
| ---: | ---: | ---: | ---: | ---: | --- |
| 1 | 12 | 1 | 87.371 | 2.629 | False |
| 2 | 1 | 2 | 93.293 | 3.293 | False |
| 3 | 2 | 3 | 90.143 | 0.143 | False |
| 4 | 3 | 4 | 90.980 | 0.980 | False |
...
| 2 | 1 | (-0.141, -1.600, 6.556) | (-0.141, 1.759, 6.556) | 3.359 | 0.000 | none |
| 3 | 3 | (-4.401, -1.600, 6.813) | (-4.401, 1.759, 6.813) | 3.359 | 0.000 | none |
| 4 | 4 | (-4.874, -1.600, -0.619) | (-4.874, 1.759, -0.619) | 3.359 | 0.000 | none |
| 5 | 6 | (-0.252, -1.600, -1.020) | (-0.252, 1.759, -1.020) | 3.359 | 0.000 | none |
| 6 | 5 | (-0.228, -1.600, -0.618) | (-0.228, 1.759, -0.618) | 3.359 | 0.000 | none |
| 7 | 8 | (0.083, -1.600, -0.636) | (0.083, 1.759, -0.636) | 3.359 | -0.000 | none |
| 8 | 7 | (0.034, -1.600, -1.444) | (0.034, 1.759, -1.444) | 3.359 | 0.000 | none |
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s4_0_40

| wall | from-to | length | direction | nearest axis | residual | short |
| ---: | --- | ---: | ---: | ---: | ---: | --- |
| 1 | 1-2 | 6.147 | 89.837 | 90.000 | 0.163 | False |
| 2 | 2-3 | 4.268 | 176.544 | 180.000 | 3.456 | False |
| 3 | 3-4 | 7.447 | 266.356 | 270.000 | 3.644 | False |
| 4 | 4-5 | 4.639 | 355.049 | 0.000 | 4.951 | False |
| 5 | 5-6 | 0.403 | 86.544 | 90.000 | 3.456 | False |
| 6 | 6-7 | 0.312 | 356.544 | 0.000 | 3.456 | True |
| 7 | 7-8 | 0.809 | 266.544 | 270.000 | 3.456 | False |
| 8 | 8-9 | 1.789 | 356.352 | 0.000 | 3.648 | False |
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s4_0_40

| pair | prev wall | next wall | turn angle | residual to 90 | warning |
| ---: | ---: | ---: | ---: | ---: | --- |
| 1 | 12 | 1 | 87.371 | 2.629 | False |
| 2 | 1 | 2 | 93.293 | 3.293 | False |
| 3 | 2 | 3 | 90.188 | 0.188 | False |
| 4 | 3 | 4 | 91.307 | 1.307 | False |
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s9_0_15
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s9_0_15
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s9_0_30
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s9_0_30
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s9_0_50
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s9_0_50
...
## Wall Metrics — m_anchor_4_1_2_1_visibility_s9_1_00
...
## Corner Metrics — m_anchor_4_1_2_1_visibility_s9_1_00
