...
- false_visual_drift_rate: `0.0000`
...
| m_anchor_1_false_drift_reference_robust_all_long_edges | diagnostic_reference | 0.6875 | 41.470 | 0.000 | rejected_false_visual_drift |
