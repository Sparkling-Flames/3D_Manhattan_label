...
- schema_version: `verified_3d_local_assist_m15_14_v1`
...
| candidate_id | operation | target_pair_indices | dx | status | improved_metrics | risk_reasons | y_change_allowed | writeback_allowed |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| translate_pair_cluster_x_dryrun_2-4_-0.50 | translate_pair_cluster_x_dryrun | [2, 4] | -0.500 | review_only | {'layout_height_spread_delta': 0.0, 'target_height_residual_sum_delta': 0.0} | [] | False | False |
| translate_pair_cluster_x_dryrun_2-4_-0.25 | translate_pair_cluster_x_dryrun | [2, 4] | -0.250 | review_only | {'layout_height_spread_delta': 0.0, 'target_height_residual_sum_delta': 0.0} | [] | False | False |
| translate_pair_cluster_x_dryrun_2-4_+0.25 | translate_pair_cluster_x_dryrun | [2, 4] | 0.250 | review_only | {'layout_height_spread_delta': 0.0, 'target_height_residual_sum_delta': 0.0} | [] | False | False |
| translate_pair_cluster_x_dryrun_2-4_+0.50 | translate_pair_cluster_x_dryrun | [2, 4] | 0.500 | review_only | {'layout_height_spread_delta': 0.0, 'target_height_residual_sum_delta': 0.0} | [] | False | False |
