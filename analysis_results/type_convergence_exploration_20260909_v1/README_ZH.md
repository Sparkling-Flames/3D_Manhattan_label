...
2026-09-10复审：本页旧分区只按OSPA距离判同簇，未落实后续“不同点数必属不同簇”的要求；旧分型亦不同于Manual粗分＋Semi细分，计算视图早于最新人工点处理。本文曲线仅作旧方法描述，不能作为当前粗／细人群持续稳定的验证。详见[分类要求与粗细分型复审](../semi_subtype_exploration_20260909_v1/分类要求与粗细分型复审_20260910.md)。
