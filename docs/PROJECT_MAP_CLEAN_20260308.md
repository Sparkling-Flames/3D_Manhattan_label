...
- `tools/paper_a_manhattan/`
  ...
  - `manhattan_m1520_local_candidate_search.py` 与 `run_m1520_local_candidate_search.py`：M15.20–M15.21 针对 task218_ann3741 的有界局部候选、专家 assertion gate/解释与 JSON/Markdown 人工审查报告；assertion 不扩大搜索，不做自动应用、标注写回、routing 或正式 artifact。
- `tools/paper_b/`
