...
- `tools/thesis_main/registry/build_c2b_worker_distribution_release.py`: derives the redacted C2-B worker-facing `D / 任务4` display lists from the frozen assignment and planned import; the external assignment manifest remains authoritative.
