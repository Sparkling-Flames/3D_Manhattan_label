...
- `tools/paper_a_manhattan/`
  ...
  - `manhattan_m1520_local_candidate_search.py` 与 `run_m1520_local_candidate_search.py`：M15.20 针对 task218_ann3741 的有界局部候选族、局部几何评分、collapse/self-intersection hard gate 与 JSON/Markdown 人工审查报告；不做全局优化、自动应用、标注写回、routing 或正式 artifact。
- `tools/paper_b/`
