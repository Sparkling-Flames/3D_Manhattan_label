...
- `tools/paper_a_manhattan/run_hrc_c6_5a_6_candidate_dry_run.py` materializes three fixed 4-pair audit-only candidates and a local 3D comparison preview for `task238_ann2389_4543gt`; it performs no search and changes no active ranking or authorization.
