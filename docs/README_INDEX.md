...
- `tools/paper_a_manhattan/run_hrc_c6_stability_audit.py` materializes the read-only C6 stability audit across active HRC buckets and evidence-only regression cases; it does not change ranking, active source, or recommendation authorization.
