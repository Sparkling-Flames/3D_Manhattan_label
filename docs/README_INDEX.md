...
- `tools/paper_a_manhattan/run_hrc_source_artifact_readiness_audit.py` materializes the C6.5a.1 case/evidence source-readiness matrix; it distinguishes existing, materializable, manual, and unavailable inputs without generating candidates, proposals, or geometry.
