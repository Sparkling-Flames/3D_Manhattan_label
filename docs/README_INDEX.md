...
- `tools/paper_a_manhattan/run_m_anchor_3_footprint_solver.py` materializes M-Anchor.3 review-only bottom_y footprint candidates after M-Anchor.2 human authorization; top_y/reorder/writeback/ranking/portfolio remain forbidden.
