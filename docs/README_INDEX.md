...
- `tools/paper_a_manhattan/run_local_3d_projection_review.py` generates M15.19–M15.23.1 local JSON/Markdown/HTML reviews, including the read-only M15.22 candidate bridge, changed-pair metadata, partial-diagnostic warnings, ghost-original comparison, and inspection tools.
