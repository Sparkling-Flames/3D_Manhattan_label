...
- `tools/paper_a_manhattan/run_hrc_gt_correction_audit.py` materializes the C6.5a.5 task238/2389 `4543gt` corrected-GT audit, old/new diagnostics, and schema-valid manual evidence sidecars; it preserves old GT and does not generate candidates or authorize C6.5b.
