...
- `tools/paper_a_manhattan/run_hrc_c6_stability_audit.py` materializes the read-only C6.3b stability audit, explicitly separating active HRC bucket audit cases from evidence-only / fixture-only cases; it does not change ranking, active source, or recommendation authorization.
