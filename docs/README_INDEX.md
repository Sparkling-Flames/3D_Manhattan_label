...
- `tools/paper_a_manhattan/run_hrc_c6_5a_7_blocker_closure_audit.py` materializes the C6.5a.7 blocker closure report and non-forged 2369 unavailable manual-sidecar records; it does not authorize C6.5b or alter active ranking.
