...
- [C2A_RP_BLOCK2_CAPACITY_AMENDMENT_20260810_v1.json](thesis_main/C2A_RP_BLOCK2_CAPACITY_AMENDMENT_20260810_v1.json)：Block 1 关闭后、Block 2 outcome 可见前冻结的一次性 `max_task_support=4` 容量修订；Block 2 结束后失效。
