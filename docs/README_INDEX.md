...
- `tools/paper_a_manhattan/run_m_anchor_1_3741.py` materializes M-Anchor.1.1 sidecar-driven expert-anchor constraints, id/seam mapping, per-wall residuals, footprint/height prototype cards, and a feedback ledger row; hard anchors fail closed and false visual drift is split into rejected/available rates.
