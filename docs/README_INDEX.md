...
- `tools/paper_a_manhattan/run_m_anchor_1_3741.py` materializes M-Anchor.1 expert-anchor constraints, id/seam mapping, per-wall residuals, footprint/height prototype cards, and a feedback ledger row; it remains audit-only and fail-closed on false visual drift.
