...
C6.1 audit、Scoring Layer Contract、C4-lite、C6.2 与 C3.1–C3.5 已完成；`manual_post_change_audit = narrow_pass_for_selection_drift_only`。C3 当前冻结为 two-family shadow state；不得进入第三个 family，不得接入 active runner selection，不得替换 `legacy_m1528`。C6 仍不是 stable ranker；C7/C9/C10 继续 blocked。
