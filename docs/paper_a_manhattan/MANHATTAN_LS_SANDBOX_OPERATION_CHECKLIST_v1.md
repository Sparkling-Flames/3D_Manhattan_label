...
- `tools/label_studio/official/ls_userscript_annotator.js` is unchanged.
- `tools/label_studio/official/ls_userscript_debug.js` is unchanged.
- `tools/label_studio/label_studio_view_config.xml` is unchanged.
- `tools/vis_3d.html` is unchanged.
- `tools/label_studio/ls_3d_logic.js` is unchanged.
...
1. Install only `tools/paper_a_manhattan/dev_only/manhattan_ls_sandbox_panel_debug.user.js`.
...
5. Install only `tools/paper_a_manhattan/dev_only/manhattan_ls_sandbox_panel_timed.user.js`.
...
```bash
python tools/paper_a_manhattan/audit_m8_sandbox_active_log.py --input active_logs/<active_time_log>.jsonl
```
