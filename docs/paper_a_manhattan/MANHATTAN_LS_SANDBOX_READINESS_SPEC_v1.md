...
- `tools/paper_a_manhattan/dev_only/manhattan_ls_sandbox_panel.user.js`
...
- Do not modify `tools/label_studio/official/ls_userscript_annotator.js`.
- Do not modify `tools/label_studio/label_studio_view_config.xml`.
- Do not modify `tools/vis_3d.html`.
- Do not modify `tools/label_studio/ls_3d_logic.js`.
