...
- `tools/thesis_main/registry/compute_dt_score.py` exists.
...
- `tools/thesis_main/registry/init_task_risk_rule_manifest.py` exists.
- `tests/test_init_task_risk_rule_manifest.py` exists.
- `docs/thesis_main/RQ3_MINIMAL_EVIDENCE_CHAIN_CONTRACT_v1.md` defines the minimum `task_risk_rule_manifest_v1.json` keys.
- `docs/thesis_main/C1_C2_ARTIFACT_FIELD_CONTRACT_v1.md` places `task_risk_rule_manifest_v1.json` in C2 final artifacts.
...
- `git status --short`
- `rg -n "Validation_OOD|Hard subset|I_t\^\{OOD\}|g_t|difficulty/model_issue|STAGE3_OOD_PREPARATION" docs/thesis_main/STAGE3_OOD_PREPARATION_PLAN_v1.md docs/shared/elsarticle/elsarticle/README_INDEX.md docs/PROJECT_MAP_CLEAN_20260308.md`
- `rg -n "AGENT_CONTEXT_INDEX|agent_playbooks|STATISTICAL_ANALYSIS_PLAN|LS_CE_ONLY" AGENTS.md docs/shared/elsarticle/elsarticle/README_INDEX.md docs/PROJECT_MAP_CLEAN_20260308.md docs/agent/AGENT_CONTEXT_INDEX.md docs/agent/playbooks`
