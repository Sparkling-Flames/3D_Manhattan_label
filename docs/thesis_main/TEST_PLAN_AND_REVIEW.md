...
> **版本**: 1.0  
> **日期**: 2026-01-18  
> **适用范围**: `tools/thesis_main/analysis/analyze_quality.py`, `tools/thesis_main/analysis/visualize_output.ipynb`, 及相关工具链
...
|-------|-------|------|---------|------|
| CI-001 | Label Studio 视图配置 | `tools/label_studio/label_studio_view_config.xml` | Git | 定义 scope/difficulty/model_issue 选项 |
| CI-002 | 分析脚本默认参数 | `tools/thesis_main/analysis/analyze_quality.py` CLI | Git | `--metric corner --quality_mode v2` |
| CI-003 | 聚合配置 | `tools/thesis_main/analysis/aggregate_config.json` | Git | 数据集映射与分组策略 |
| CI-004 | 可视化清洗逻辑 | `tools/thesis_main/analysis/visualize_output.ipynb` | Git | `clean_quality_df()` 函数 |
