% Source: Paper_A_新版完整论文提纲_vFinal_Draft.md §16
\section{结果章节结构}
...
和 pooled worker profile、Strong Global/Full activation 及 sensitivity。Stage 3 gate 的十项依赖、
roster SHA 和 enrollment registry SHA 作为结果完整性表的一部分公开。
