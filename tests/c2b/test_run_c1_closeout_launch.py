...
def test_stage3_test_candidate_preserves_rows_records_exposure_and_is_candidate_only(monkeypatch, tmp_path):
    ...
    assert summary["source_method_binding"]["target_method_contract_version"] == "paper_a_method_20260811_v23"
...
def test_d8_v17_to_v18_repackage_preserves_assignment_and_records_dual_deployment_sha(tmp_path):
    ...
    assert result["method_contract_version"] == "paper_a_method_20260811_v23"
    ...
    assert envelope["target_method_contract_sha256"] == "f3c1ea58d0857a40aa2240b4680b674c76fe2cec8f048f61a643d9e4b74b0588"
