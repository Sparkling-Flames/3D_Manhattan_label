...
EXPECTED_ANALYZE_QUALITY_HEADER = [
    ...
    "active_time_page_gate_ineligible_event_count",
    ...
    "active_time_store_mismatch_event_count",
    "active_time_labeling_root_missing_event_count",
    "active_time_editor_missing_event_count",
    "active_time_main_view_missing_event_count",
    "lead_time_seconds",
    "iou",
    "iou_manual",
    "iou_corner",
