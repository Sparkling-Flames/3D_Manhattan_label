...
def test_gt_pending_does_not_close_peer_or_structural(tmp_path):
    ...
    _write(canonical,[{"canonical_annotation_id":"c","annotation_id":"a","worker_id":"w","base_task_id":"b","project_id":"p","ls_runtime_task_id":"l","task_id":"t","condition":"manual","assigned_expected":True,"outside_assignment_submission":False,"duplicate_worker_task_submission":False}])
