...
def test_quality_reads_fresh_canonical_choice_payload(tmp_path: Path) -> None:
    ...
    _write(meta, ["canonical_registry_sha256", "source_artifact", "source_sha256", "source_export_sha256", "task_id", "base_task_id", "dataset_group", "worker_id", "canonical_annotation_id", "choice_map_json", "difficulty_present", "model_issue_present", "canonical_eligibility_status", "schema_interpretable", "n_corners", "geometry_hash", "assigned_expected"], [{"canonical_registry_sha256": sha, "source_artifact": str(raw), "source_sha256": raw_sha, "source_export_sha256": raw_sha, "task_id": "t", "base_task_id": "b", "dataset_group": "Calibration_anchor", "worker_id": "w", "canonical_annotation_id": "a1", "choice_map_json": json.dumps({"difficulty": ["occlusion"], "model_issue": ["acceptable"]}), "difficulty_present": "true", "model_issue_present": "true", "canonical_eligibility_status": "valid", "schema_interpretable": "true", "n_corners": "4", "geometry_hash": "g", "assigned_expected": "true"}])
