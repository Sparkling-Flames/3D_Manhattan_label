...
def test_ls_project_mapping_v3_1_audits_counts_and_redaction(tmp_path: Path) -> None:
    ...
    _csv(release / "worker_facing_distribution_zh_merged_v3_1.csv", ["public_worker_code", "worker_name", "task_code"], [{"public_worker_code": "W001", "worker_name": "张三", "task_code": row["task_code"]} for row in internal])
