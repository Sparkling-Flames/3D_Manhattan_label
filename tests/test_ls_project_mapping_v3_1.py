...
def test_ls_project_mapping_v3_1_audits_counts_and_redaction(tmp_path: Path) -> None:
    ...
    internal_fields = ["worker_id", "public_worker_code", "task_id", "base_task_id", "inner_id", "task_url", "dataset_group", "assignment_batch", "expected_completion_order", "source_manifest", "internal_only"]
    internal = []
