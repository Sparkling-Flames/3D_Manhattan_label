...
python tools/thesis_main/analysis/materialize_p1_post_closeout_evidence_correction.py --help
python tools/thesis_main/analysis/materialize_p1_post_closeout_geometry_scores.py --help
