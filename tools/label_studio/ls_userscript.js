...
(function () {
  ...
  console.warn(
    "HoHoNet: tools/label_studio/ls_userscript.js 目前保留为兼容入口；正式标注请使用 tools/label_studio/official/ls_userscript_annotator.js，调试请使用 tools/label_studio/official/ls_userscript_debug.js",
  );
