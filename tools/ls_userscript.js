...
(function () {
  ...
  console.warn(
    "HoHoNet: tools/ls_userscript.js 目前保留为兼容入口；正式标注请使用 tools/official/ls_userscript_annotator.js，调试请使用 tools/official/ls_userscript_debug.js",
  );
  ...
  function getViewerBaseUrl() {
    try {
      return window.localStorage.getItem("HOHONET_VIEWER_BASE_URL") || getHelperBaseUrl();
    } catch (e) {
  ...
  const SCRIPT_VERSION = "0.23-official-root";
