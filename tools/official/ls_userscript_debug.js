...
(function () {
  ...
  function isActiveTimeLoggingDisabled() {
    try {
      const forcedDisable = window.localStorage.getItem("HOHONET_DISABLE_ACTIVE_TIME") === "1";
      const explicitEnable = window.localStorage.getItem("HOHONET_ENABLE_DEBUG_ACTIVE_TIME") === "1";
