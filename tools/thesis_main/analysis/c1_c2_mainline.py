...
def materialize_c2b_design_worker_profile(
    ...
    for worker in sorted(set(completion) | set(state) | set(parameter) | set(readiness)):
        ...
        rows.append({
            ...
            "F_struct": s.get("F_struct_EB", ""), "F_struct_numerator": s.get("F_struct_numerator", ""), "F_struct_denominator": s.get("F_struct_denominator", ""), "F_struct_status": r.get("F_struct_status", "insufficient_support"),
