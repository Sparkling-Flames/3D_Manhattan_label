...
def materialize_geometry_consensus(
    ...
    *,
    ...
    write_csv_rows(output_dir / "geometry_worker_task_peer_C1.csv", peer_rows, fields + ["base_task_id", "building_id", "task_id", "worker_id", "canonical_annotation_id", "peer_similarity_values", "R_peer_boundary_median", "R_peer_wall_median", "R_peer_conservative_median", "R_peer_median", "R_peer_mean", "peer_count", "peer_metric_compatible_count", "peer_dispersion", "similarity_definition"])
