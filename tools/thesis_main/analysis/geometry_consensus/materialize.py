...
def materialize_geometry_consensus(
    ...
    *,
    ...
    write_csv_rows(output_dir / "geometry_worker_task_loo_C1.csv", loo_rows, fields + ["base_task_id", "geometry_context_schema_version", "geometry_context_provenance", "task_id", "worker_id", "canonical_annotation_id", "held_out_valid", "peer_count_excluding_self", "valid_k", "loo_boundary_median", "loo_wallwall_median", "q_boundary_median", "q_wallwall_median", "loo_boundary_values_json", "loo_wallwall_values_json", "q_LOO_tu", "q_LOO_primary", "q_LOO_tie_min", "q_LOO_tie_max", "q_LOO_tie_mean", "tie_sensitivity_only", "loo_consensus_status", "task_consensus_status", "primary_loo_eligible", "sensitivity_loo_eligible", "loo_consensus_annotation_id", "loo_consensus_worker_id", "loo_consensus_geometry_sha256", "loo_largest_cluster_support", "loo_maximum_cluster_count", "tied_medoid_count", "held_out_tied_medoid_iou_min", "held_out_tied_medoid_iou_max", "held_out_tied_medoid_iou_range"])
