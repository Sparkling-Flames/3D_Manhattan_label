...
def crowd_structure(
    ...
    return {
        ...
        "cluster_margin_all": (len(largest) - len(second)) / valid_k if valid_k else None,
        "cluster_margin_top2": (len(largest) - len(second)) / (len(largest) + len(second)) if len(largest) + len(second) else None,
