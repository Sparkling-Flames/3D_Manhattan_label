# 示例   整个目录
#   python tools/thesis_main/analysis/lead_time_stats.py export.json --active-log .
# 增加了 --project 参数，允许你只统计特定项目的工时：
#   python tools/thesis_main/analysis/lead_time_stats.py export.json --active-log . --project 15
"""Utility to compute Label Studio lead_time for HoHoNet experiments.

Usage:
  python tools/thesis_main/analysis/lead_time_stats.py path/to/manual.json path/to/semiauto.json
  python tools/thesis_main/analysis/lead_time_stats.py /path/to/dir   # process all json files in dir
