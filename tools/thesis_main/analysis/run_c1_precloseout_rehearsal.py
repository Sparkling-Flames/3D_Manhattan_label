...
def materialize(
    ...
    review_sources = {name: path for name, path in {
        ...
        "w034_preassignment_timing_verification_attestation": w034_preassignment_timing_verification_attestation,
    ...
    canonical_summary = c1_canonicalize_exports.build_canonicalization(
        ...
        w034_preassignment_timing_verification_attestation=review_snapshots.get("w034_preassignment_timing_verification_attestation"),
