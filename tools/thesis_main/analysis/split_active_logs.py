...
Usage examples:
  ...
  python tools/thesis_main/analysis/split_active_logs.py --src active_logs/active_logs --dst active_logs/new_server --version 0.22

  # split by date (ISO date or YYYY-MM-DD): select records on/after cutoff
  python tools/thesis_main/analysis/split_active_logs.py --src active_logs/active_logs --dst active_logs/new_server --since 2026-02-28
